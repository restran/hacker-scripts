# -*- coding: utf-8 -*-
# Created by restran on 2016/10/12

"""
https://github.com/yrhcz/tcp-proxy/blob/master/tcpproxy.py
"""
...
def receive_from(connection):
    ...
    # depending on your target, you may have to adjust this
...
def request_handler(buf):
    ...
    # modify any requests destined for local host
...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    while True:
        ...
        # if no more data on either sid, close the connections
